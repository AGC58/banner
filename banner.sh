...
function banner(){
figlet -f big HOS GELDINIZ| lolcat
#echo -e "\n"
echo "                 ______________________________________         "|lolcat
echo "        ________|                                      |_______ "|lolcat
echo "        \       |  BU BİR TERMUX AFİSİDİR LUTFEN DEVAM EDİNİZ   |      / "|lolcat
echo "         \      |                                      |     /  "|lolcat
echo "         /      |______________________________________|     \  "|lolcat
echo "        /__________)                                (_________\ "|lolcat
echo ""
echo -e "\e[1;36m                        Coded By -> Djb3b358\n"
...
+-----------------------------------------------------------------------+
	1.Ejder               	6.sarılma
	2.Dragon               	7.Süt
	3.Dragen-and-cow       	8.Hayvan1
	4.Gözler                	9.Hindi
	5.Head-In              	10.Hayvan3
+-----------------------------------------------------------------------+
\033[0m";
